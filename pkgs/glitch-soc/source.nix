...
(applyPatches {
  src = fetchFromGitHub {
    owner = "arachnist";
    repo = "mastodon";
    rev = "a20be614f9674c672e545f82219603bf2217812d";
    hash = "sha256-bjZh7moIOgpcfxBg5qe600scQ99VO/bTSn3iEZdbqLU=";
  };
  inherit patches;
  ...
  yarnHash = "sha256-9c5AATs7JKQld4gr+XRnw2a+m+Ti8+TZUX8LcghMEK4=";
}
